...
#import "MKQIZAdviceVC.h"


#import "AppDelegate.h"

#define WIDTH [UIScreen mainScreen].bounds.size.width
@interface MKQIZAdviceVC ()<UITextViewDelegate,UIActionSheetDelegate>
...
{
    MKQIZAdviceVC *advice = [Worker MainSB:@"AdviceVC"];
    advice.diff = diff;
