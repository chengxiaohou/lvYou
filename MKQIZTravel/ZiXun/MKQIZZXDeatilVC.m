...
#import "MKQIZZXDeatilVC.h"

@interface MKQIZZXDeatilVC ()
...
- (IBAction)onBuy:(UIButton *)sender {
    ...
    [MKQIZOrderDetailVC showTheOrderDetailVC:_parmter];
}
