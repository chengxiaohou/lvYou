...
#import "MKQIZSettingVC.h"

@interface MKQIZSettingVC ()
...
@implementation MKQIZSettingVC
+(void)showTheSettingVC
{
    MKQIZSettingVC *set = [Worker MainSB:@"SettingVC"];
    [Worker showVC:set];
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (IBAction)Exit:(UIButton *)sender {
    ...
    [self showFunctionAlertWithTitle:nil message:@"确认退出吗？" functionName:@"确定" Handler:^{
        ...
        [MKQIZSettingVC gotoVCIfLogin:self];
