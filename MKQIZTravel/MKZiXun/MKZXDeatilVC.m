...
#import "MKZXDeatilVC.h"

@interface MKZXDeatilVC ()
...
- (IBAction)onCommentBtn:(UIButton *)sender {
    [MKAdviceVC showTheAdviceVC:200];
}

#pragma mark 立即购买
- (IBAction)onBuy:(UIButton *)sender {
   
    [MKOrderDetailVC showTheOrderDetailVC:_parmter];
}
