...
#import "MKShoppingVC.h"
#define CollectWID 170
@interface MKShoppingVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (weak, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic,strong) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic,strong) NSArray *MJDatas;
@end

@implementation MKShoppingVC
+ (void)showTheShoppingVC:(NSInteger)diff
{
    MKShoppingVC *shopping = [Worker MainSB:@"ShoppingVC"];
    shopping.diff = diff;
...
- (void)onTap:(UITapGestureRecognizer *)tap
{
    ...
    [MKZXDeatilVC showTheZXDeatilVC:dic[@"url"] andTheName:@"" andTheDiff:100 andTheDic:dic];
}
