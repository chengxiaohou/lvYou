...
#import "MKQIZShoppingVC.h"
#define CollectWID 170
@interface MKQIZShoppingVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (weak, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic,strong) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic,strong) NSArray *MJDatas;
@end

@implementation MKQIZShoppingVC
+ (void)showTheShoppingVC:(NSInteger)diff
{
    MKQIZShoppingVC *shopping = [Worker MainSB:@"ShoppingVC"];
    shopping.diff = diff;
...
- (void)onTap:(UITapGestureRecognizer *)tap
{
    ...
    [MKQIZZXDeatilVC showTheZXDeatilVC:dic[@"url"] andTheName:@"" andTheDiff:100 andTheDic:dic];
}
