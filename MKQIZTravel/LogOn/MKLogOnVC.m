...
@interface MKLogOnVC ()<UITextViewDelegate,UITextFieldDelegate>
...
- (IBAction)ToForgetPassWord:(UIButton *)sender {
    ...
    [MKForgetPassWordVC showTheForgetPassWordVC:100];
}
