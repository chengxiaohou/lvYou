...
#import "MKQIZForgetPassWordVC.h"

@interface MKQIZForgetPassWordVC ()<UITextFieldDelegate>
...
@implementation MKQIZForgetPassWordVC
+(void)showTheForgetPassWordVC:(NSInteger)diff
{
    MKQIZForgetPassWordVC *forget = [Worker MainSB:@"ForgetPassWordVC"];
    forget.diff = diff;
