...
#import "MKQIZChangePasswordVC.h"

@interface MKQIZChangePasswordVC ()
...
@implementation MKQIZChangePasswordVC
+(void)showTheChangePasswordVC
{
    MKQIZChangePasswordVC *chageVC = [Worker MainSB:@"ChangePasswordVC"];
