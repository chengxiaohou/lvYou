...
#import "MKQIZPersonInfoVC.h"

@interface MKQIZPersonInfoVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,NavViewDelegate,UITextFieldDelegate>
...
@implementation MKQIZPersonInfoVC
+ (void)showThePersonInfoVC
{
    MKQIZPersonInfoVC *person = [Worker MainSB:@"PersonInfoVC"];
...
- (void)viewDidLoad {
    ...
    [_view6 setClickEvent:^{
        //修改登录密码
         [MKQIZForgetPassWordVC showTheForgetPassWordVC:200];
    }];
