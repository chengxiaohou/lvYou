...
#import "MKQIZMineVC.h"

@interface MKQIZMineVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet EETableView *tableView;

@property (nonatomic,strong) NSArray *datas;
@end

@implementation MKQIZMineVC
...
- (IBAction)toPersonVC:(id)sender {
    ...
    {
     [MKQIZPersonInfoVC showThePersonInfoVC];
    }
}
    ...
    if (indexPath.section > 0) {
        ...
        switch (tag) {
            case 0:
                    ...
                    //意见反馈
                    [MKQIZAdviceVC showTheAdviceVC:100];
...
//                    [self.navigationController pushViewController:web animated:YES];
            ...
            case 2:
                //设置
                [MKQIZSettingVC showTheSettingVC];
                break;
            case 3:
                //我的黑名单
                [MKQIZBlakListVC showTheBlakListVC];
                break;
            case 4:
                //客服咨询
