...
#import "MKQIZBlakListVC.h"

@interface MKQIZBlakListVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet EETableView *tableView;
@property (nonatomic,strong) NSMutableArray *datas;
@end

@implementation MKQIZBlakListVC
+ (void)showTheBlakListVC
{
    MKQIZBlakListVC *black = [Worker MainSB:@"BlakListVC"];
    [Worker showVC:black];
}
- (void)viewDidLoad {
    [super viewDidLoad];
