...
#import "MKQIZLogOnVC.h"

@interface MKQIZLogOnVC ()<UITextViewDelegate,UITextFieldDelegate>
...
- (IBAction)ToForgetPassWord:(UIButton *)sender {
    ...
    [MKQIZForgetPassWordVC showTheForgetPassWordVC:100];
}
