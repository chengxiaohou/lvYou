...
@interface MKQIZMyDongTaiVC ()<UITextViewDelegate,UIActionSheetDelegate,NavViewDelegate,
...
@implementation MKQIZMyDongTaiVC
{
...
{
    MKQIZMyDongTaiVC *dongTai = [Worker MainSB:@"MyDongTaiVC"];
