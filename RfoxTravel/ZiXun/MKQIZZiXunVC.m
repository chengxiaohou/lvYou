...
#import "MKQIZZiXunVC.h"

@interface MKQIZZiXunVC ()<UITableViewDelegate,UITableViewDataSource,NavViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic,strong) NSMutableArray *datas;
@end

@implementation MKQIZZiXunVC
...
- (void)right
{
    [MKQIZMyDongTaiVC showTheMyDongTaiVC];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_datas.count > 0) {
        NSDictionary *dic = _datas[indexPath.row];
        [MKQIZZXDeatilVC showTheZXDeatilVC:dic[@"url"] andTheName:@"" andTheDiff:200 andTheDic:dic];
    }
}
