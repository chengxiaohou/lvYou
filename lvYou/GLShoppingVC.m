...
@interface GLShoppingVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (weak, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic,strong) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic,strong) NSArray *MJDatas;
@end

@implementation GLShoppingVC
+ (void)showTheShoppingVC:(NSInteger)diff
{
    GLShoppingVC *shopping = [Worker MainSB:@"ShoppingVC"];
    shopping.diff = diff;
...
- (void)onTap:(UITapGestureRecognizer *)tap
{
    ...
    [GLZXDeatilVC showTheZXDeatilVC:dic[@"url"] andTheName:@"" andTheDiff:100 andTheDic:dic];
}
