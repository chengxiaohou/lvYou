...
@interface PersonInfoVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,NavViewDelegate,UITextFieldDelegate>
...
{
    PersonInfoVC *person = [Worker MainSB:@"PersonInfoVC"];
...
- (void)viewDidLoad {
    ...
    [_view6 setClickEvent:^{
        //修改登录密码
         [ForgetPassWordVC showTheForgetPassWordVC:200];
    }];
