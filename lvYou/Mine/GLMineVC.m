...
@interface GLMineVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet EETableView *tableView;

@property (nonatomic,strong) NSArray *datas;
@end

@implementation GLMineVC
...
- (IBAction)toPersonVC:(id)sender {
    ...
    {
     [GLPersonInfoVC showThePersonInfoVC];
    }
}
    ...
    if (indexPath.section > 0) {
        ...
        switch (tag) {
            case 0:
                    ...
                    //意见反馈
                    [GLAdviceVC showTheAdviceVC:100];
...
//                    [self.navigationController pushViewController:web animated:YES];
            ...
            case 2:
                //设置
                [GLSettingVC showTheSettingVC];
                break;
            case 3:
                //我的黑名单
                [GLBlakListVC showTheBlakListVC];
                break;
            case 4:
                //客服咨询
