...
@interface GLPersonInfoVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,NavViewDelegate,UITextFieldDelegate>
...
@implementation GLPersonInfoVC
+ (void)showThePersonInfoVC
{
    GLPersonInfoVC *person = [Worker MainSB:@"PersonInfoVC"];
...
- (void)viewDidLoad {
    ...
    [_view6 setClickEvent:^{
        //修改登录密码
         [GLForgetPassWordVC showTheForgetPassWordVC:200];
    }];
