...
@interface ZiXunVC ()<UITableViewDelegate,UITableViewDataSource,NavViewDelegate>
...
- (void)right
{
    [MyDongTaiVC showTheMyDongTaiVC];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_datas.count > 0) {
        NSDictionary *dic = _datas[indexPath.row];
        [ZXDeatilVC showTheZXDeatilVC:dic[@"url"] andTheName:@"" andTheDiff:200 andTheDic:dic];
    }
}
