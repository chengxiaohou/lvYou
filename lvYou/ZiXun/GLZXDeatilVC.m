...
- (IBAction)onCommentBtn:(UIButton *)sender {
    [GLAdviceVC showTheAdviceVC:200];
}

#pragma mark 立即购买
- (IBAction)onBuy:(UIButton *)sender {
   
    [GLOrderDetailVC showTheOrderDetailVC:_parmter];
}
