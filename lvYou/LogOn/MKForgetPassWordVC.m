...
#import "MKForgetPassWordVC.h"

@interface MKForgetPassWordVC ()<UITextFieldDelegate>
...
@implementation MKForgetPassWordVC
+(void)showTheForgetPassWordVC:(NSInteger)diff
{
    MKForgetPassWordVC *forget = [Worker MainSB:@"ForgetPassWordVC"];
    forget.diff = diff;
